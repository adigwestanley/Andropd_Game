...
public class DatabaseHandler extends SQLiteOpenHelper{
	...
	private static String DB_PATH = "/data/data/com.example.ruan_lopes.fluky/databases/";
    ...
    public ArrayList<Level> getLevels(int levelType)
    {
    	ArrayList<Level> levels = new ArrayList<Level>();
    	 String query = "Select level_num, type, time, word, enabled FROM level  WHERE type = " + levelType;

    	Cursor cursor = db.rawQuery(query, new String[]{});
    	
    	if (cursor.moveToFirst()) {
            do {
    		    levels.add(new Level(Integer.parseInt(cursor.getString(0)), Integer.parseInt(cursor.getString(1)), Integer.parseInt(cursor.getString(2)), cursor.getString(3), Integer.parseInt(cursor.getString(4))));
                System.out.println("AHH " + cursor.getString(0));
